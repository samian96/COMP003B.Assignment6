...
namespace COMP003B.Assignment6.Controllers
{
    public class BookAuthorsController : Controller
    {
        ...
        public BookAuthorsController(OnlineBookStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var onlineBookStoreContext = _context.BookAuthors.Include(b => b.Author).Include(b => b.Book);
        ...
        public async Task<IActionResult> Create([Bind("Id,AuthorId,BookId")] BookAuthor bookAuthor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AuthorId,BookId")] BookAuthor bookAuthor)
        {
            if (id != bookAuthor.Id)
            {
                return NotFound();
